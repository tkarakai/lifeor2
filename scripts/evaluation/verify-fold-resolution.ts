...
try {
 ...
 const prior=JSON.parse(await readFile(new URL('future-appointment-postconditions.json',root),'utf8'));
 ...
 await writeFile(new URL('fold-resolution-postconditions.json',root),JSON.stringify(result,null,2));
